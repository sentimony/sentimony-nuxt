...
const logoOldUrl = "https://content.sentimony.com/assets/img/svg-icons/sentimony-records-logo.svg?01"
...
<template>
  <div class="bg-black/50">
    <div class="max-w-lg mx-auto px-2 py-10">
      ...
      <p>
        <!-- <NuxtImg class="mx-auto" :src="logoNewUrlv1" :alt="logoNewAltv1" width="60" height="60" /> -->
        <!-- <NuxtImg class="mx-auto" :src="logoNewUrlv2" :alt="logoNewAltv3" width="60" height="60" /> -->
        <!-- <NuxtImg class="mx-auto" :src="logoNewUrlv3" :alt="logoNewAltv3" width="60" height="60" /> -->
        <NuxtImg class="mx-auto" :src="logoOldUrl" :alt="logoOldAlt" width="60" height="60" />
      </p>
    </div>
  </div>
