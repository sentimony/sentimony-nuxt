...
<template>
  ...
  >
    ...
    >
      ...
      <div v-if="i.coming_soon" class="text-white text-[8px] md:text-[10px] leading-none absolute -top-0.75 md:top-0 -right-0.75 md:right-0 bg-green-700 shadow-[0_2px_10px_0_rgba(0,0,0,0.5)] p-1 rounded-tr-sm rounded-bl-sm">Coming Soon</div>
      <div v-if="i.new" class="text-white text-[8px] md:text-[10px] leading-none absolute -top-0.75 md:top-0 -right-0.75 md:right-0 bg-red-700 shadow-[0_2px_10px_0_rgba(0,0,0,0.5)] p-1 rounded-tr-sm rounded-bl-sm">Out Now</div>
