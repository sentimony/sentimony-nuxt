...
const props = withDefaults(defineProps<TooltipContentProps & { class?: HTMLAttributes["class"], arrowClass?: HTMLAttributes["class"] }>(), {
  sideOffset: 4,
})
...
<template>
  <TooltipPortal>
    ...
    >
      ...
      <TooltipArrow :class="cn('bg-foreground fill-foreground z-50 size-2.5 translate-y-[calc(-50%_-_2px)] rotate-45 rounded-xs', props.arrowClass)" />
    </TooltipContent>
  </TooltipPortal>
</template>
