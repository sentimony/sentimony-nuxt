...
<template>
  <div data-testid="site-header" class="sticky top-0 left-0 w-full z-20 border-b border-black/10 dark:border-white/30 bg-background/80 dark:bg-white/5 backdrop-blur-sm overflow-hidden">
    <div class="px-0">
