...
Перенести P2 #9 і #10 у «Закрито» в `ROADMAP.md` (з приміткою про per-instance ліміт і опцію Netlify rate limiting rules).

```bash
git add tests/e2e/api-security.spec.ts ROADMAP.md
