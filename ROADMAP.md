...
оновлення картинок pwa, бо не подобається як виглядає на macos, логотип в притик, а хотілось би з випираючими елементами логотипа
впевнитись що зараз використовується валідна дизайн система

===

оновити рідмі щоб були іконки як аджаілчартс
