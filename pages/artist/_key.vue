  ...
  <div class="artist-page">
    ...
    <div class="content">
      <div class="content__wrapper">
        ...
        <div v-if="artist.information">
          <div v-html="artist.information" />
          <hr>
        </div>
        ...
        <div v-if="artist.category === 'designer'">
          <p v-if="artist.category === 'designer'"><small><b>{{ artist.title }}'s gallery:</b></small></p>
          <!-- <p><small><b>Gallery:</b></small></p> -->
